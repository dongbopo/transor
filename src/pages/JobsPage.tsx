    ...
    <div className="max-w-7xl mx-auto">
      ...
      >
        <div className="stat-card">
          ...
          <div className="text-2xl font-bold text-gray-900">{state.documents.length}</div>
          <div className="text-xs text-gray-500 mt-1">All documents</div>
        </div>
        ...
        <div className="stat-card">
          ...
          <div className="text-xs text-green-600 mt-1">Ready to view</div>
        </div>
